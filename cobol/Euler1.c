...
#define COB_SOURCE_FILE		"Euler1.cob"
...
#include "Euler1.c.h"  /* local variables */
  ...
  /* Euler1.cob:10: CALL */
  cob_set_location ("myTest", "Euler1.cob", 10, "MAIN SECTION", "MAIN PARAGRAPH", "CALL");
  {
    {
      int (*func)();
  ...
  /* Euler1.cob:12: DISPLAY */
  cob_set_location ("myTest", "Euler1.cob", 12, "MAIN SECTION", "MAIN PARAGRAPH", "DISPLAY");
  {
    cob_new_display (0, 1, 1, &f_6);
  }
  /* Euler1.cob:13: STOP */
  cob_set_location ("myTest", "Euler1.cob", 13, "MAIN SECTION", "MAIN PARAGRAPH", "STOP");
  {
...
#include "Euler1.c.h"  /* local variables */
  ...
  /* Euler1.cob:26: PERFORM */
  cob_set_location ("euler1", "Euler1.cob", 26, "MAIN SECTION", "MAIN PARAGRAPH", "PERFORM");
  {
    while (1)
      {
        if (((int)cob_cmp_numdisp (b_14, 4, 0) <= 0))
          break;
        {
          /* Euler1.cob:27: DIVIDE */
          cob_set_location ("euler1", "Euler1.cob", 27, "MAIN SECTION", "MAIN PARAGRAPH", "DIVIDE");
          {
            cob_div_quotient ((f_14.data = b_14, &f_14), &c_1, &f_12, 2);
            cob_div_remainder (&f_13, 2);
          }
          /* Euler1.cob:28: IF */
          cob_set_location ("euler1", "Euler1.cob", 28, "MAIN SECTION", "MAIN PARAGRAPH", "IF");
          {
            if (((int)cob_cmp_numdisp (b_13, 3, 0) == 0))
              {
                /* Euler1.cob:29: ADD */
                cob_set_location ("euler1", "Euler1.cob", 29, "MAIN SECTION", "MAIN PARAGRAPH", "ADD");
                {
              ...
              {
                /* Euler1.cob:31: DIVIDE */
                cob_set_location ("euler1", "Euler1.cob", 31, "MAIN SECTION", "MAIN PARAGRAPH", "DIVIDE");
                {
                  cob_div_quotient ((f_14.data = b_14, &f_14), &c_2, &f_12, 2);
                  cob_div_remainder (&f_13, 2);
                }
                /* Euler1.cob:32: IF */
                cob_set_location ("euler1", "Euler1.cob", 32, "MAIN SECTION", "MAIN PARAGRAPH", "IF");
                {
                  if (((int)cob_cmp_numdisp (b_13, 3, 0) == 0))
                    {
                      /* Euler1.cob:33: ADD */
                      cob_set_location ("euler1", "Euler1.cob", 33, "MAIN SECTION", "MAIN PARAGRAPH", "ADD");
                      {
                        cob_add ((f_15.data = b_15, &f_15), (f_14.data = b_14, &f_14), 2);
                      }
                    }
          ...
          /* Euler1.cob:37: ADD */
          cob_set_location ("euler1", "Euler1.cob", 37, "MAIN SECTION", "MAIN PARAGRAPH", "ADD");
          {
  ...
  /* Euler1.cob:39: EXIT */
  cob_set_location ("euler1", "Euler1.cob", 39, "MAIN SECTION", "MAIN PARAGRAPH", "EXIT");
  {
    if (module.next)
      goto exit_program;
  }
